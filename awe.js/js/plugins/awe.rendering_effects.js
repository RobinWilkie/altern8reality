...
//            return;
      ...
      awe.settings.update = function(BODY, HEAD) {
        ...
        if (BODY.where.id && (BODY.where.id == 'view_mode' %7C%7C (BODY.where.includes && BODY.where.id.includes('view_mode'))) ) {
        ...
        if (BODY.where.id && (BODY.where.id == 'view_count' %7C%7C (BODY.where.includes && BODY.where.id.includes('view_count'))) ) {
          var view_count = awe.settings.view('view_count') ? awe.settings.view('view_count').value() : 'mono';
